package subject.marchnine.twenty.first;
import java.util.Scanner;

import subject.marchnine.twenty.second.Account;
			...
			if (choice.equals("1")) {
				...
				if (cnt < 100) {
					...
					while(true) {
						...
						if(leng.length() == 7) {
//							ac[cnt].account = leng; // 이건 String 객체 leng의 참조값을 복사하는 것 같아서 밑의 방식으로 시도
							ac[cnt].account = String.valueOf(leng);
							break;
						} else {
